/**
 * Preserved full multi-page homepage.
 *
 * This is the original homepage implementation, kept intact so the full site
 * can be restored later. Reactivate it by setting SITE_MODE to "full" in
 * src/config/site-mode.ts — see LAUNCH.md.
 */
    ...
    <div className="bg-[#07111d] pb-16">
      ...
      <section className="bg-[#0a1c2e] px-6 py-8 sm:px-10 sm:py-12">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 sm:flex-row sm:items-center sm:gap-8">
          <div className="relative h-48 w-48 shrink-0 overflow-hidden sm:h-64 sm:w-64">
            <Image
              src="/mouritzen.jpg"
